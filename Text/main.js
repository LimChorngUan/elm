...
var $author$project$Main$initialModel = {content: ''};
...
var $author$project$Main$ChangeContent = function (a) {
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onInput($author$project$Main$ChangeContent)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$p,
